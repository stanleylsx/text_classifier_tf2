...
class ElectraClassification(tf.keras.Model, ABC):
    def __init__(self, num_classes):
        super(ElectraClassification, self).__init__()
        self.max_sequence_length = classifier_config['max_sequence_length']
        self.electra_model = TFElectraModel.from_pretrained(classifier_config['pretrained'])
    ...
    def call(self, inputs, training=None):
        ...
        last_hidden_state = self.electra_model(input_ids=inputs, attention_mask=bert_mask_ids).last_hidden_state
