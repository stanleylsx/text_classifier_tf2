...
class RoBertaClassification(tf.keras.Model, ABC):
    def __init__(self, num_classes):
        super(RoBertaClassification, self).__init__()
        self.max_sequence_length = classifier_config['max_sequence_length']
        self.roberta_model = TFRobertaModel.from_pretrained(classifier_config['pretrained'])
    ...
    def call(self, inputs, training=None):
        ...
        last_hidden_state = self.roberta_model(input_ids=inputs, attention_mask=bert_mask_ids).last_hidden_state
