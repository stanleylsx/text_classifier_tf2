...
class BertClassification(tf.keras.Model, ABC):
    def __init__(self, num_classes):
        ...
        self.bert_model = TFBertModel.from_pretrained(classifier_config['pretrained'])
    ...
    def call(self, inputs, training=None):
        ...
        last_hidden_state = self.bert_model(input_ids=inputs, attention_mask=bert_mask_ids).last_hidden_state
